                        ...
                        {sortedTrades.map((trade) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={cn(
                                        "p-3 rounded-2xl cursor-pointer transition-all duration-500 border relative group overflow-hidden",
                                        isSelected
                                ...
                                >
                                    {isSelected && (
                                        <div className="absolute inset-0 border border-primary/40 rounded-2xl pointer-events-none shadow-[inset_0_0_10px_rgba(11,102,228,0.1)]" />
                                    )}

                                    <div className="flex items-center justify-between mb-2.5">
                                        <div className="flex items-center gap-2">
                                            {trade.symbol.includes('XAU') ? (
                                                <img src="/gold.png" alt="Gold" className="w-7 h-7 object-contain shrink-0 drop-shadow-md" />
                                            ) : (
                                                <div className="w-7 h-7 rounded-full bg-amber-400 flex items-center justify-center shadow-[0_0_10px_rgba(251,191,36,0.1)] shrink-0">
                                            ...
                                            <div className="space-y-0.5">
                                                <p className="text-xs font-black text-white tracking-tight uppercase leading-none">{trade.symbol}</p>
                                                <span className={cn(
                                        ...
                                        <div className="text-right">
                                            ...
                                            <p className="text-[7px] font-bold text-muted-foreground/30 uppercase tracking-widest">{trade.volume} Lots</p>
                                        </div>
                                    </div>

                                    <div className="grid grid-cols-2 gap-2 text-[8px] font-bold text-muted-foreground/30">
                                        <div className="space-y-0.5">
                                            <p className="uppercase tracking-[0.15em] text-[6px] opacity-60">Entry:</p>
                                            <p className="text-white/80 font-mono text-[9px]">${trade.price_open}</p>
                                        </div>
                                        <div className="space-y-0.5">
                                            <p className="uppercase tracking-[0.15em] text-[6px] opacity-60">Exit:</p>
                                            <p className="text-white/80 font-mono text-[9px]">${trade.price_close}</p>
                                        </div>
                                    </div>

                                    <div className="mt-2 flex items-center justify-between text-[7px] font-black uppercase tracking-[0.2em] pt-2 border-t border-white/[0.02]">
                            ...
                            <div className="h-full flex flex-col">
                                ...
                                <div className="flex items-center justify-between mb-8">
                                    <div className="flex items-center gap-3">
                                        <div className="flex items-center gap-3">
                                            {selectedTrade.symbol.includes('XAU') ? (
                                                <img src="/gold.png" alt="Gold" className="w-8 h-8 object-contain shrink-0 drop-shadow-md" />
                                            ) : (
