...
export function PerformanceChart({ analyticsData, className, period, setPeriod }: PerformanceChartProps & { className?: string; period: string; setPeriod: (p: string) => void }) {
    const { user } = useAuth();
