...
const TradersLounge: React.FC = () => {
    ...
    return (
        <div className="h-screen bg-background flex flex-col overflow-hidden">
            ...
            <div className="h-14 border-b border-border/40 flex items-center px-4 bg-background/80 backdrop-blur shrink-0 justify-between">
                    ...
                    <div className="flex-1 overflow-y-auto overflow-x-hidden relative z-10 px-4 pb-4">
                        <div className="max-w-3xl mx-auto py-6">
                            ...
                            <motion.div
                                ...
                                className="text-center py-10 mb-8 border-b border-border/40 mx-4"
                            >
