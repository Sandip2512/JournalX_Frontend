...
import { TopSymbols, DayPerformance, LongVsShort } from "@/components/analytics/TradeAnalysisCharts";
...
import { TraderRadarChart } from "@/components/analytics/TraderRadarChart";
    ...
    return (
        <UserLayout>
            <div className="space-y-4 animate-fade-up">
                ...
                <Tabs defaultValue="performance" className="w-full space-y-4 text-foreground">
                    ...
                    <TabsContent value="performance" className="space-y-4 border-none p-0 outline-none">
                        {/* Top Stat Cards */}
                        <PerformanceMetrics stats={stats} />

                        {/* Main Row: Equity Curve, Radar, and Quick Stats */}
                        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                            ...
                            <div className="lg:col-span-1">
                                <TraderRadarChart stats={stats} className="h-full" />
                            </div>
                            <div className="lg:col-span-1">
