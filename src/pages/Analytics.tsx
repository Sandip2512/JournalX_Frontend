...
const Analytics = () => {
  ...
  if (!analytics || !analytics.beginner || analytics.beginner.total_trades === 0) {
    return (
      <div className="min-h-screen">
        <Header />
  ...
  const renderStats = () => {
    ...
    if (level === "beginner") {
      stats = [
        ...
        { label: "Win Rate", value: `${analytics.beginner.win_rate.toFixed(1)}%`, icon: Target, color: "text-primary", bg: "bg-primary/10" },
